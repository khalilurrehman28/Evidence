package com.dupleit.kotlin.primaryschoolassessment.getStudents.adapter;
...
public class getStudentsAdapter extends RecyclerView.Adapter<getStudentsAdapter.MyViewHolder>implements Filterable{
    private Context mContext;
    private List<GetStudentData> studentsOfClassList;
    private List<GetStudentData> studentListFiltered;
    private StudentsAdapterListener listener;
    ...
    public getStudentsAdapter(Context mContext, List<GetStudentData> studentsOfClassList, StudentsAdapterListener listener) {
        this.mContext = mContext;
        this.listener = listener;
        this.studentsOfClassList = studentsOfClassList;
        this.studentListFiltered = studentsOfClassList;
    }
    ...
    @Override
    public void onBindViewHolder(final getStudentsAdapter.MyViewHolder holder, int position) {
        ...
        return new Filter() {
            ...
            protected FilterResults performFiltering(CharSequence charSequence) {
                ...
                if (charString.isEmpty()) {
                    studentListFiltered = studentsOfClassList;
                } else {
                    List<GetStudentData> filteredList = new ArrayList<>();
                    for (GetStudentData row : studentsOfClassList) {
    ...
    public interface StudentsAdapterListener {
        void onContactSelected(GetStudentData students);
    }
}