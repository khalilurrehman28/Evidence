package com.dupleit.kotlin.primaryschoolassessment.fragments.allStudents.adapter;
...
public class allStudentsAdapter extends RecyclerView.Adapter<allStudentsAdapter.MyViewHolder> implements Filterable {
    ...
    public allStudentsAdapter(Context mContext, ArrayList<GetStudentData> studentList, ContactsAdapterListener listener) {
    ...
    @Override
    public void onBindViewHolder(final allStudentsAdapter.MyViewHolder holder, int position) {
