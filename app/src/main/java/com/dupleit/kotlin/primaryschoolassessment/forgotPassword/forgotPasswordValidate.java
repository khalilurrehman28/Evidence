...
public class forgotPasswordValidate extends AppCompatActivity {
    private final TextWatcher mTextEditorWatcherConfirmPassword = new TextWatcher() {
        ...
        public void afterTextChanged(Editable s) {
            ...
            if (s.toString().trim().length()<1 ){
                viewConfirmPassword.setBackgroundResource(0);
            }
        }
    };
    Button btnCreate;
    ImageView imgPassword1,imgConfirmPassword1;
    ...
    private final TextWatcher mTextEditorWatcherPassword = new TextWatcher() {
        ...
        public void afterTextChanged(Editable s) {
            ...
            if (s.toString().trim().length()>0 && s.toString().trim().length()<3){
                ...
                viewPassword.setBackgroundResource(0);
            }
        }
    };
    ...
    private void hitApi() {
        ...
        if (!checkInternetState.getInstance(forgotPasswordValidate.this).isOnline()) {
            ...
            Call<forgotPasswordResponse> userCall = service.updatePassword(keyCode,emailIntent,password);
            userCall.enqueue(new Callback<forgotPasswordResponse>() {
                ...
                public void onFailure(Call<forgotPasswordResponse> call, Throwable t) {
                    ...
                    Toasty.error(forgotPasswordValidate.this, "Fail"+t.toString(), Toast.LENGTH_LONG, true).show();
                }
            });
        }
    }
