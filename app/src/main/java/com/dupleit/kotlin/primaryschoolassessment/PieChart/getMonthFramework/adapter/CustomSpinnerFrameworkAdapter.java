package com.dupleit.kotlin.primaryschoolassessment.PieChart.getMonthFramework.adapter;
...
public class CustomSpinnerFrameworkAdapter extends BaseAdapter implements SpinnerAdapter {

    private final Context activity;
    private ArrayList<FrameworkData> frameworkList;

    public CustomSpinnerFrameworkAdapter(Context context, ArrayList<FrameworkData> asr) {
